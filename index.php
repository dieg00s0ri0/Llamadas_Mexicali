  ...
  ?>
              ...
              <div class="p-2 rounded-4 col-md-12" style=" background-color: #E8ECEF; border: inherit;">
                ...
                <div class="row align-items-start form-row">
                  <div class="col-md-8">
                    ...
                    <input class="form-control form-control-sm" name="Rmonitoreo" id="Rmonitoreo" type="file" onchange="return validarExtM()" onchange="toggleButton()" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" required>
                  </div>
                ...
                <div class="row align-items-start form-row">
                  <div class="col-md-8">
                    ...
                    <input class="form-control form-control-sm" name="monitoreoI" id="monitoreoI" type="file" onchange="return validarExtI()" onchange="toggleButton()" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" required>
                  </div>
                ...
                <div class="row align-items-start form-row">
                  <div class="col-md-6">
                    ...
                    <select class="form-select form-select-sm" name="mes" id="listames" aria-label=".form-select-sm example" required>
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="number" value="<?php echo date('Y') ?>" class="form-control form-control-sm" name="anio" id="anio">
                  </div>
                </div>
              </div>
              ...
              <div class="form-row p-4">
                <div class="col">
                  <div style="text-align:right;">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm" id="btn" onclick="return confirmacion()" value="Submit" disabled><i class="fa fa-upload"></i> Subir Archivos</button>
                  </div>
                </div>
              </div>
            </form>
      ...
      <script>
        function confirmacion() {
          ...
          var mes = listames.options[listames.selectedIndex].value;
          anio = document.getElementById("anio").value;
          let meses = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'];
          var respuesta = confirm("Los archivos corresponden al mes de " + meses[mes - 1] + " del año " + anio + ", es correcto?")
          if (respuesta == true) {
            return true;
          } else {
            return false;
      ...
      <script src="validaciones/habilitar.js"></script>
      <script src="validaciones/validar_ext.js"></script>

    <?php
    } else {
      // Usuario no autorizado, mostrar mensaje de error con SweetAlert
    ?>
      <script>
        Swal.fire({
          icon: 'error',
